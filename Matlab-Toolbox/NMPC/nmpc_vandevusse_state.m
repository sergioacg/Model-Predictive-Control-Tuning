function dydt = nmpc_vandevusse_state(x, u)
% vandevusse_model - Van de Vusse non-isothermal reactor ODE model with the
% signature of the NMPC toolbox to Specify Prediction Model for Nonlinear MPC
%
%The prediction model of a nonlinear MPC controller consists of the 
...
%
% USAGE:
%   dydt = nmpc_vandevusse_model(x, u)
%
% INPUTS:
